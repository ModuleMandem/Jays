...
if game.PlaceId == 8343259840 then
	local Success, Error = pcall(function()
		...
		local Version                           = "Jays 1.B (Slave Owner)"
		...
		function JoinDiscord()  
			...
			StarterGui:SetCore("SendNotification", {Title = Version; Text = "Xi Jingping: Mandate Of Heaven"; Icon = "rbxassetid://8426126371"; Duration = 30 })
		end
		...
		local Framework                = loadstring(game:HttpGet("https://raw.githubusercontent.com/ModuleMandem/Jays/main/TestUI.lua", true))() -- https://raw.githubusercontent.com/JackHiggly/RobloxThings/main/TestUI
		local ESPFramework             = loadstring(game:HttpGet("https://raw.githubusercontent.com/ModuleMandem/Jays/main/Esp.lua", true))()
...
--[[
		...
		MainS:AddButton("Melee God Mode", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/ModuleMandem/Jays/main/meleegod.lua", true))()
		end)
		...
		CreditsS:AddLabel("For Nigga Jays")
		CreditsS:AddLabel("Module - Script Homie")
